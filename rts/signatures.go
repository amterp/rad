...
func init() {
	signatures := []FnSignature{
		...
		newFnSignature(`http_get(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_post(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_put(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_patch(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_delete(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_head(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_options(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_trace(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
		newFnSignature(`http_connect(url: str, *, body: any?, headers: map?) -> { "success": bool, "status_code"?: int, "body"?: any, "error"?: str, "duration_seconds": float }`),
