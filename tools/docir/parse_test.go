...
func TestParse_DropsHTMLComments(t *testing.T) {
	src := lines(
		"<!-- GENERATED by tools/gen-errors-page from core/error_docs/. DO NOT EDIT. -->",
		"",
		"# Errors",
		"",
		"<!-- a",
	...
	if strings.Contains(got, "<!--") || strings.Contains(got, "-->") {
		t.Fatalf("HTML comment leaked into output:\n%s", got)
	}
	for _, want := range []string{"# Errors", "Real prose."} {
		if !strings.Contains(got, want) {
			t.Fatalf("dropped real content %q:\n%s", want, got)
		}
	}
}

func TestParse_UnterminatedHTMLCommentStaysText(t *testing.T) {
	// No closing `-->`: must not swallow the rest of the doc.
	src := lines(
		"<!-- oops never closed",
		"# Still Here",
	)
	...
	if !strings.Contains(got, "# Still Here") {
		t.Fatalf("unterminated comment swallowed the doc:\n%s", got)
	}
}
