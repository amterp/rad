...
Version 0.9 introduces changes to error handling operators, renames a built-in function, and enables invocation logging by default. This guide covers what changed and how to update your scripts.
