...
```rad
parse_date(_date: str) -> map|error
parse_date(_date: str, *, format: str?) -> map|error
parse_date(_date: str, *, tz: str = "local") -> map|error
parse_date(_date: str, *, format: str?, tz: str = "local") -> map|error
```
